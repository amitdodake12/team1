            ...
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="actionpage.php"><img src="icon/force.jpg" /></a></i>
                     <h3>Action</h3>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="romancepage.php"><img src="icon/96.jpg"/></a></i>
                     <h3>Romance</h3>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="Thrillerpage.php"><img src="icon/talaash.jpg" /></a></i>
                     <h3>Thriller</h3>
                  </div>
               </div>
               </div>
