            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="wazir.php"><img src="icon/wazir.jpg" /></a></i>
                     <h3>Wazir</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="drishyam.php"><img src="icon/drishyam.jpg"/></a></i>
                     <h3>Drishyam</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="talaash.php"><img src="icon/talaash.jpg" /></a></i>
                     <h3>Talaash</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <a><a href="satyameva.php"><img src="icon/satyameva.jpg" /></a></i>
