            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="force.php"><img src="icon/force.jpg" /></a></i>
                     <h3>Force</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="extraction.php"><img src="icon/extraction_netflix_xlg.jpg"/></a></i>
                     <h3>Extractionn</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="commando.php"><img src="icon/commando.jpg" /></a></i>
                     <h3>Commando</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <a><a href="Avengers.php"><img src="icon/avengers_endgame_ver45_xlg.jpg" /></a></i>
