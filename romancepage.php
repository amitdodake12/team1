            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="96.php"><img src="icon/96.jpg" height="200px" width="200px"/></a></i>
                     <h3>'96</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="kabirsingh.php"><img src="icon/kabir singh.jpg" height="200px" width="200px"/></a></i>
                     <h3>Kabir singh</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><a href="rockstar.php"><img src="icon/rockstar.jpg"/></a></i>
                     <h3>Rockstar</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <a><a href="lunchbox.php"><img src="icon/luchbox.jpg"/></a></i>
                     <h3>Lunch Box</h3>
                  </div>
               </div>
              </div>
